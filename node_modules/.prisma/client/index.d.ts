...
export namespace Prisma {
  ...
  */
  ...
  export type transactionGetPayload<
    ...
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'user' ? userGetPayload<Exclude<S['select'], undefined | null>[P]> :  P extends keyof transaction ? transaction[P] : never
  } 
    : transaction
  : transaction
  ...
  export interface transactionDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'transaction'> extends True ? CheckSelect<T, Prisma__transactionClient<transaction>, Prisma__transactionClient<transactionGetPayload<T>>> : CheckSelect<T, Prisma__transactionClient<transaction | null, null>, Prisma__transactionClient<transactionGetPayload<T> | null, null>>
   ...
   */
  export class Prisma__transactionClient<T, Null = never> implements PrismaPromise<T> {
    [prisma]: true;
  ...
  export type userGetPayload<
    ...
    ? user  & {
    [P in TrueKeys<S['include']>]:
        P extends 'transaction' ? Array < transactionGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends '_count' ? UserCountOutputTypeGetPayload<Exclude<S['include'], undefined | null>[P]> :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'transaction' ? Array < transactionGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
  ...
  export class Prisma__userClient<T, Null = never> implements PrismaPromise<T> {
    ...
    transaction<T extends transactionFindManyArgs = {}>(args?: Subset<T, transactionFindManyArgs>): CheckSelect<T, PrismaPromise<Array<transaction>| Null>, PrismaPromise<Array<transactionGetPayload<T>>| Null>>;
